...
model = Model(p)
model.add_layer(CurrentLoading(K=K_f, r=r_1, mu_r=mu_r1))
model.add_layer(CurrentLoading(K=0, r=r_2, mu_r=1))
...
for i in range(1, 1001):
    ...
    model = Model(p_i)
    model.add_layer(CurrentLoading(K=K_i, r=r_i1, mu_r=mu_ir1))
    model.add_layer(CurrentLoading(K=0, r=r_i2, mu_r=1))
