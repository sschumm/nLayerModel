...
""" Generator #1: p = 25, l_e = 0.2, k_fill_s = 0.3, k_fill_r = 0.2, B_yoke_max = 6 [T] """
if 0:
    ...
    ax = pyplot.subplot()
    ax.plot(theta, - flux_data.Br)
    # pyplot.savefig(fname = "Radial Flux Density in Airgap.png")
    pass
    

#%%
""" Generator #2: p = 25, l_e = 0.2, k_fill_s = 0.3, k_fill_r = 0.2"""
if 0:
    # --- init generator with main parameter ---
    p = 25
    l_e = 0.2
...
#%%
""" Generator #3: p = 30, l_e = 0.3, k_fill_s = 0.3, k_fill_r = 0.2, B_yoke_max = 2 [T] """
if 1:
    # --- init generator with main parameter ---
    p = 30
    l_e = 0.3
    ...
    # --- init generator dimension via yoke and winding heights ---
    h_yoke_s, h_yoke_r = 0.02 * r_so, 0.02 * r_so
    h_wndg_s, h_wndg_r = [factor * (gn.h_pole_frame*2) for factor in [1.5, 1.3]]
...
#%%
""" Generator #4: p = 12, l_e = 0.6, k_fill_s = 0.3, k_fill_r = 0.2"""
if 0:
    # --- init generator with main parameter ---
    p = 12
    l_e = 0.6
...
#%%
""" Generator #5: p = 30, l_e = 0.4, k_fill_s = 0.5, k_fill_r = 0.4"""
if 0:
    # --- init generator with main parameter ---
    p = 30
    l_e = 0.4
