...
#%%
    geno.update_dimensions(h_wndg_s = 0.043, h_wndg_r=0.015)
    # geno.apply_coil_thickness_ratio()
    geno.apply_coil_thickness_ratio()
    geno.apply_lift_factor()
    geno.adapt_yokes()
...
#%%        
    if 1:
        increasing_h_by_factor=0.043
        break_when_P_at_factor=0.5
    
        lst_P, lst_h_wndg_r, lst_Brc = [geno.P], [0.015], [geno.B_r_c]
...
geno.update_dimensions(h_wndg_r=0.032, h_wndg_s=0.03)
geno.apply_coil_thickness_ratio()
geno.apply_lift_factor()
