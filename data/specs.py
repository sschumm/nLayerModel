...
class FieldWinding():
    ...
    J_e = 20/1.7 # ~ 11.8 [A/mm2] - engineering current density
...
class StatorWinding_77K():
    ...
    T_HTS = 77 # [K] - LN2 - Liquid Nitrogen
    J_e = 20/1.7 # ~ 11.8 [A/mm2] - engineering current density
    C_e = 0.5 * 117 # [kVA min/m3] - Essons Number - electromagnetic utilization
    d2so_L = 11.28 # [m3]
...
class StatorWinding_30K():
    ...
    T_HTS = 30 # [K] - LNe - Liquid Neon
    J_e = 270/1.7 # ~ 158.8 [A/mm2] - engineering current density
    C_e = 0.5 * 1575.9 # [kVA min/m3] - Essons Number - electromagnetic utilization
    d2so_L = 1 # [m3]