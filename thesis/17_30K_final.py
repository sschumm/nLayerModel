...
geno.update_dimensions(h_wndg_r=0.037, h_wndg_s=h_pf * 2.1)
geno.apply_coil_thickness_ratio()
geno.apply_lift_factor()
geno.adapt_yokes()
geno.apply_coil_thickness_ratio()
...
#%%      
geno.update_dimensions(h_wndg_s=0.033)
geno.apply_coil_thickness_ratio()
geno.apply_lift_factor()
geno.adapt_yokes()
geno.apply_coil_thickness_ratio()
...
#%%    
geno.update_dimensions(h_wndg_r = 0.06)
geno.apply_coil_thickness_ratio()
geno.apply_lift_factor()
geno.adapt_yokes()
geno.apply_coil_thickness_ratio()
